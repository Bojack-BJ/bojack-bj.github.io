...
<div class="media-grid">
  <figure>
    <video controls autoplay muted loop playsinline src="/uploads/lemon-cup.MOV"></video>
    <figcaption>Put lemon into cup</figcaption>
  </figure>
  <figure>
    <video controls autoplay muted loop playsinline src="/uploads/cube-box.MOV"></video>
    <figcaption>Put cube into box</figcaption>
  </figure>
  <figure>
    <video controls autoplay muted loop playsinline src="/uploads/stack_cube.mp4"></video>
    <figcaption>Stack two cubes</figcaption>
  </figure>
  <figure>
    <video controls autoplay muted loop playsinline src="/uploads/cup1.MOV"></video>
